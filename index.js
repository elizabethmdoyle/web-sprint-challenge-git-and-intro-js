...
console.log(artists[0].name, 'task 1');


//(2) Bio of the third artist (2nd index) in the array 

console.log(artists[2].bio, 'task 2')
...
console.log(removeArtist(artists, 2), 'task 5')
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 6: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 
...
function artistInfo(artists, nameString ){
    for(let i = 0; i < artists.length; i++) {
...
function artistByCountry(artists, nationString){
  let countryArray = [];

  for(let i = 0; i < artists.length; i++) {
    if(artists[i].nationality === nationString) {
...
console.log(artistByCountry(artists, 'Spanish'), 'task 9')
